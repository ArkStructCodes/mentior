...
class ErrorID(Enum):
    ...
    # Invalid values for custom data field (customDataBase64).
    # Happens when data is provided here but it's no valid JPG/PNG data or image dimensions are invalid.
...
class ErrorInfo(BaseModel):
    ...
    error_id: ErrorID = Field(..., validation_alias="errorID")
    message: str
